...
<head>
  ...
  <title>PUC Alumni - Amirul Islam</title>
  ...
  <div class="container">
    <div class="row g-4 mb-5">
      <div class="col-md-4 text-center">
        <img src="img/alumni1.png" alt="Mohammed Mohiuddin" class="img-fluid rounded shadow-sm mb-3" />
        <h4 class="fw-bold">Mohammed Mohiuddin</h4>
        <p><strong>Date of Birth:</strong> 22/02/2001</p>
        <p><strong>Email:</strong> mohiuddin2531@gmail.com</p>
        <p><strong>LinkedIn:</strong> <a href="http://linkedin.com/in/mohiuddin2531/" target="_blank">Profile</a></p>
      </div>
      ...
      <div class="col-md-8">
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <p><strong>Graduation Year/Batch:</strong> 2024, Batch: 37th</p>
          </div>
        </div>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <p><strong>Current Job:</strong>  Coding Instructor</p>
            <p><strong>Company:</strong> Dreamers Academy</p>
            <p><strong>Previous Workplaces:</strong></p>
            <ul>
              <li>Futurenation (UNDP Bangladesh)</li>
            </ul>
            <p><strong>Work Experience:</strong> 1+ years</p>
          </div>
        </div>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <p><strong>Hobbies:</strong> Computer Programming, Software Engineering, AI/ML Research</p>
            <p><strong>Achievements:</strong> Chairperson - IEEE Premier University SB '24, VP - Robotics Club '24, Campus Facilitator - UNDP, Coding Instructor</p>
            <p><strong>Success Story:</strong> Due to networking and technical skills landed my first job right after finishing bachelors course work and handled multiple clubs and opportunities.</p>
            <p><strong>Quote:</strong> "Focus on the basics, build a strong network, and balance your goals."</p>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a class="text-light" href="index.php#event">Gallery</a></li>
